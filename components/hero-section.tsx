...
const HeroSection = () => {
    return (
        <section>
            ...
            <div className='absolute -left-[20vw] w-[140vw] -translate-y-[180px] top-full h-[180px] overflow-hidden'>
              <div className='glowing-oval'></div>
            </div>

            <div className='flex flex-col items-center pb-20'>
              <h1 className='z-10 text-center text-8xl mt-24 mb-4 font-medium'>Design & Build <br /> Softwares Solutions.</h1>
              ...
              <button className='z-10 border border-[#E39CD1] bg-[#330658] py-4 px-7 text-lg rounded-full mt-10 btn-shadow'>
                Start a project
              </button>
            </div>
        </section>
